...
const History = () => {
  ...
  return (
    <div className="bg-gray-100 h-[43vw] overflow-hidden shadow-md rounded items-center">
      <div className="mx-5 rounded">
        <h1 className="text-3xl font-semibold pt-6 mb-6 text-yellow-500">Histórico de Produtos</h1>
        ...
        <div className="flex justify-between items-center -mt-2">
          <button
            ...
            className="px-4 py-2 m-2 bg-yellow-500 text-white rounded disabled:bg-gray-300"
          >
            Anterior
          </button>
